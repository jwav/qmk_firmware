...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_split_3x6_3(KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_WH_U, KC_MS_U, KC_WH_D, KC_NO, KC_TRNS, KC_TRNS, KC_NO, KC_ACL0, KC_ACL1, KC_ACL2, KC_NO, KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, KC_TRNS, KC_TRNS, KC_NO, KC_NO, TO(5), TO(6), KC_NO, KC_BTN4, KC_BTN1, KC_BTN3, KC_BTN2, KC_BTN5, KC_TRNS, KC_NO, TO(0), KC_NO, KC_BTN1, KC_ACL2, KC_NO),
	[5] = LAYOUT_split_3x6_3(KC_TRNS, KC_A, KC_Z, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, fCOLN, KC_TRNS, KC_TRNS, KC_Q, KC_R, KC_S, KC_T, KC_G, FR_M, KC_N, KC_E, KC_I, KC_O, KC_NO, KC_TRNS, KC_W, KC_X, KC_C, KC_D, KC_V, KC_K, KC_H, fCOMM, fDOT, fSLSH, KC_TRNS, TO(0), LT(2,KC_ENT), LSFT_T(KC_TAB), LSFT_T(KC_BSPC), LT(1,KC_SPC), RCTL_T(KC_ENT)),
	[6] = LAYOUT_split_3x6_3(KC_TRNS, KC_A, KC_Z, KC_D, KC_F, KC_B, KC_Y, KC_J, KC_K, KC_L, KC_P, KC_TRNS, KC_TRNS, KC_Q, KC_S, KC_E, KC_T, KC_G, KC_H, KC_N, KC_I, KC_O, KC_R, KC_TRNS, KC_TRNS, KC_W, KC_X, KC_C, KC_V, fCOMM, fDOT, KC_U, FR_M, fSLSH, fCOLN, KC_TRNS, TO(0), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
